...
def shop():
    ...
    bullets_text = blockyfontsmall.render("Buy Weapons", True, white)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Weapons button
                if button_clicked(0.625, 0.667, 0.125, 0.083, mouse):
                    credits_()

                # Options button
                if button_clicked(0.125, 0.833, 0.125, 0.083, mouse):
                    options()

                # Rules button
                if button_clicked(0.125, 0.667, 0.125, 0.083, mouse):
                    under_construction()
        ...
        # Weapons button
        draw_button(grey, light_grey, 0.625, 0.667, 0.125, 0.083, bullets_text, blockyfontsmall)
